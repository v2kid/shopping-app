...
import { useGetDetialsQuery } from "../store/App.service";
...
const DetailsScreen = ({
  ...
  const {data} = useGetDetialsQuery(id)
  return (
    <View style={{ flex: 1 }}>
      <Image
        source={{
      ...
      >
        ...
        >
          ...
          >
            {like ?(
           <Icons name="favorite" size={24} color={"#F80A76"} />
            ):(
            <Icons name="favorite-border" size={24} color={"#F80A76"} />
            )}
          ...
          >
            <Icons name="add-shopping-cart" size={24} color={"#4C9DB8"} />
          </TouchableOpacity>
        </View>
      </SafeAreaView>
